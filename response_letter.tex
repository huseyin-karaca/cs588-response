...
\newcommand{\AutoRevision}[1]{%
    \begin{tcolorbox}[
        ...
        \renewcommand{\do}[1]{%
            ...
            \ifinlist{\RevHash}{\RevPrintedList}{%
            }{%
...
\begin{center}
    {\Large \textbf{Response to Reviewers}}\\[0.4em]
    \textbf{Manuscript:} Graph Enhanced Transformer for 
    Semi-Supervised Duplicate Bug Report Detection\\ 
    \textbf{Authors:} Kerem Bayramoğlu, Hüseyin Karaca, Emirhan Koç, Hasan Erkin Ünlü, Rabia Ela Ünlü
\end{center}
\hrule \vspace{1em}
...
\noindent We thank the reviewer for the careful review and positive comments, particularly regarding the strong baseline comparisons and effective use of unlabeled data.

\begin{ReviewCycle}{Comment 1.1}
    ...
    \AutoRevision{1.5,4.11}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 1.2}
    ...
    \AutoRevision{1.6,2.3,2.7,3.7}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 1.3}
    ...
    \AutoRevision{4.5,4.6,3.6,1.3,1.7,4.8,4.9}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 1.4}
...
\noindent We thank the reviewer for the thorough evaluation and constructive criticism.

\begin{ReviewCycle}{Comment 2.1}
    ...
    \AutoRevision{2.1,2.5}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 2.2}
    ...
    \AutoRevision{2.2,2.6}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 2.3}
    ...
    \AutoRevision{2.3,2.7,3.7}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 2.4}
    ...
    \AutoRevision{2.4,2.8}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 2.5}
...
\begin{ReviewCycle}{Comment 3.1}
    ...
    \AutoRevision{3.3,4.3}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 3.2}
...
\begin{ReviewCycle}{Comment 3.3}
    ...
    \AutoRevision{3.2,3.8}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 3.4}
    ...
    \AutoRevision{3.5,3.9,4.14}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 3.5}
...
\begin{ReviewCycle}{Comment 3.6}
    ...
    \AutoRevision{3.1,4.1}
\end{ReviewCycle}

\begin{ReviewCycle}{Comment 3.7}
...
\noindent We thank the reviewer for appreciating the technical rigor and practical applicability of our work.

\begin{ReviewCycle}{Comment 4.1}
...
\begin{ReviewCycle}{Comments 4.3--4.10}
...
\begin{ReviewCycle}{Comment 4.11}
    ...
    \AutoRevision{3.1,4.1,4.2}
\end{ReviewCycle}

\begin{ReviewCycle}{Comments 4.12--4.28}
    ...
    \AutoRevision{1.7,4.8,4.9,4.11,4.12,4.13,3.5,3.9,4.14}
\end{ReviewCycle}
