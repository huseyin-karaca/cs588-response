...
\revised{4.6}{Changed keyword from ``Issue'' to ``Bug Report'' and capitalized ``Semi-Supervised Learning''.}
...
\end{figure*}
\revised{4.9}{Figure 1 caption: corrected ``token id's'' to ``token IDs''.}
